...
class Academy_Awards_Table {
    ...
    public function get_entity_rows($entity, $id) {
        ...
        $sql = "SELECT ceremony, year, class, canonical_category, category, film, film_id, name, nominees, nominee_ids, winner, detail, note, citation FROM $table_name WHERE $where ORDER BY ceremony DESC, canonical_category ASC, winner DESC, id DESC";
    ...
    public function ajax_get_awards_datatable() {
        ...
        // Data
        $fields = 'ceremony, year, class, canonical_category, category, film, film_id, name, nominee_ids, winner, detail, note, citation';
        ...
        foreach ($rows as $i => $row) {
            ...
            $rows[$i]['category_slug'] = $cat ? sanitize_title($cat) : '';
        }
